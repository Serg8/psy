    ...
    return (
        <div className={classes.wrapperDevelop}>
            ...
            <div>
                ...
                <button onClick={increment} className={`${classes.btn} ${classes.btnSuccess}`}>Add</button>
                <button onClick={decrement} className={`${classes.btn} ${classes.btnDelete}`}>Remove</button>
                <button onClick={changeTitle} className={`${classes.btn} ${classes.btnDefault}`}>Change title</button>
            ...
            <h2>Ресурс: {type}</h2>
            <button onClick={users} className={`${classes.btn} ${classes.btnDefault}`}>Пользователи</button>
            <button onClick={todos} className={`${classes.btn} ${classes.btnDefault}`}>toDos</button>
            <button onClick={posts} className={`${classes.btn} ${classes.btnDefault}`}>Посты</button>
            ...
            <button className={classes.btnDefault} onClick={focus}> focus</button>
